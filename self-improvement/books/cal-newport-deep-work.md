...
- Eudaimonia Machine: Gallery (examples of deep work), salon (for curiosity), library (a record of all work done in the machine), office space, deep work chamber.
- People fight desires all day long: eating, sleeping, sex, checking e-mail/social networking, surfing the web, listening to music, watching television.
- You have a finite amount of willpower that becomes depleted as you use it.
- The key to developing a deep work habit is to move beyond good intentions and add routines and rituals to your working life designed to minimize the amount of your limited willpower necessary to transition into and maintain a state of unbroken concentration.
- Donald Knuth's email address: "I have been a happy man ever since January 1, 1990, when I no longer had an email address. I’d used email since about 1975, and it seems to me that 15 years of email is plenty for one lifetime. Email is a wonderful thing for people whose role in life is to be on top of things. But not for me; my role is to be on the bottom of things. What I do takes long hours of studying and uninterruptible concentration."
- Monastic philosophy of deep work scheduling: eliminating or radically minimizing shallow obligations.
- Neal Stephenson: "If I organize my life in such a way that I get lots of long, consecutive, uninterrupted time-chunks, I can write novels. But as those chunks get separated and fragmented, my productivity as a novelist drops spectacularly.
- Carl Jung: bimodal philosophy, dividing your time to have some deep work, and some shallow work. He believes that deep work can produce extreme productivity, but only if the subject dedicates enough time to such endeavors to reach maximum cognitive intensity.
- Seinfeld: "The way to be a better comic is to write better jokes, and the way to create better jokes is to write every day." Chain method.
...
- Vague commitment to deep work: It needed to happen in ninety-minute chunks. He made a rule that he would wake up and start working by five thirty every morning. He would then work until seven thirty, make breakfast, and go to work already done with his dissertation obligations for the day.
- "Who's to say that I can't be that prolific? Why not me?"
- Problem with rhythmic philosophy: you still have to respond to the boss's email.
- Ritualize:
  - Every placed book, every placed notebook, what he puts on his wall, what he wears to the office: everything is specified by a routine that has varied little. "I train myself to be organized."
  - Charles Darwin: Wake at the same time, then eat breakfast alone, then retire to his study, then reading letters, then he would think about ideas while walking on a proscribed route and then circled a path around his property.
  - "Great creative minds think like artists but work like accountants."
  - Great minds didn't deploy rituals to be weird; they did so because success in their work depended on their ability to go deep, again and again. Their rituals minimized the friction in this transition to depth, allowing them to go deep more easily and stay in the state longer.
- Ritual:
  - Where you'll work and for how long.
  - How you'll work once you start to work.
  - How you'll support your work: coffee, exercise.
  - Gesture: J.K. Rowling checked into a luxurious hotel (big change in normal environment) dedicated towards supporting a deep work task. You then think of an increased perceived importance of the task.
  - Alan Lightman: retreats each summer to a "tiny island" in Maine to think deeply and recharge.
  - Writing cabins..
  - Inventing the transistor: he locked himself in a room until he had a better design.
  - Writing while up in the air?
  - Psychology: committing so seriously to the task at hand. Putting yourself in an exotic location to focus on a writing project.
- Professors at MIT: want the ability to close themselves off. We have the solo thinker, isolated from inspiration but free from distraction, and the fully collaborative thinker in an open office.
- Hub and spoke: areas of deep work around areas of collaboration.

### 4 Disciplines of Execution

- Focus on the wildly important.
  - Identify a small number of ambitious outcomes to pursue with your deep work hours.
  - Have a specific goal that should return tangible and substantial professional benefits.
  - Don't try to say "no" to the distractions but say "yes" to the subject that arouses a terrifying longing.
- Act on the lead measures.
  - Lag = things like papers published per year, the task has to be done first.
  - Lead = amount of deep work, since you do this before the task.
- Keep a compelling scoreboard.
  - Physical artifact in the workspace that displays the individual's current deep work count.
- Cadence of accountability.
  - Team members must confront their scoreboard, commit to specific actions, and describe what happened with the commitments they made at a last meeting.

### Why a Shutdown Is Good

- *Downtime aids insights.* Distracted group performed better before doing a complex decision regarding a car purchase.
  - For decisions that involve large amounts of information and multiple vague constraints, your unconscious mind is well-suited to tackle the issue.
- *Downtime helps recharge the energy needed to work deeply.* The nature advantage: taking a walk around nature performs better. Spending time in nature can improve your ability to concentrate? Walking on busy city streets requires you to use directed attention, but walking around nature exposes you to inherently fascinating stimuli.
  - Not even because of having a good mood. When they tried harsh winter, they still ended up doing better on concentration tasks.
  - Relaxing activities: casual conversation with a friend, listening to music while making dinner, playing a game with your kids, going for a run play the same attention-restoring role as walking in nature.
...
- Elite violinists: deliberate practice is done for about 3 hours. The less accomplished players spent less time in a state of depth. By evening, you're beyond the point where you can continue to effectively work deeply. Any work you do fit into the night won't be the type of high-value activities, but will be shallow tasks.
- Shutdown ritual: every incomplete task, goal, or project has been reviewed and that for each, you have confirmed that either you have a plan or it's captured in a place where it will be revisited when the time is right.
- **There will always be tasks left incomplete.** The idea that you can ever reach a point where all your obligations are handled is a fantasy. However if you commit to a plan for a goal, it may not only achieve that goal, but it may also free cognitive resources for other pursuits.
- Regularly resting your brain improves the quality of your deep work. When you work, you work hard. When you're done, be done.

## Embrace Boredom

- The ability to concentrate intensely is a skill that must be trained. The idea might sound obvious but it represents a departure from how people understand such matters.
- You know that undistracted concentration is important. You know that you need to exercise your mental muscle.
...
- The use of a distracting service does not reduce your brain's ability to focus. It's instead the constant switching from low-stimuli/high value activities to high-stimuli/low-value activities, at the slightest hint of boredom or cognitive challenge, that teaches your mind to never tolerate an absence of novelty.
...
- It's like you will have Internet blocks and no Internet blocks.
